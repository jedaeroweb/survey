...
User.create!(:id=>1,:branch_id=>1,:name=>'어흥',:email => 'test@jedaeroweb.co.kr',:password => 'a12345', :password_confirmation => 'a12345',:birthday=>'1981-06-02',:job=>'웹프로그래머',:live_type_id=>2,:education_id=>5,:sex=>true,:enable=>true)
User.create!(:id=>2,:branch_id=>1,:name=>'라라라랄',:email => 'test2@jedaeroweb.co.kr',:password => 'a12345', :password_confirmation => 'a12345',:birthday=>'1981-06-02',:job=>'무',:live_type_id=>2,:education_id=>5,:sex=>false,:enable=>true)
User.create!(:id=>3,:branch_id=>1,:name=>'멍멍',:email => 'user1@jedaeroweb.co.kr',:password => 'a12345', :password_confirmation => 'a12345',:birthday=>'1981-06-02',:job=>'애완견',:live_type_id=>1,:education_id=>4,:sex=>false,:enable=>true)
User.create!(:id=>4,:branch_id=>1,:name=>'야옹',:email => 'U10K-00002@jedaeroweb.co.kr',:password => 'a12345', :password_confirmation => 'a12345',:birthday=>'1981-06-02',:job=>'쥐사냥',:live_type_id=>1,:education_id=>3,:sex=>true,:enable=>true)
User.create!(:id=>5,:branch_id=>1,:name=>'ㅋㅋㅋ',:email => 'U10K-00003@jedaeroweb.co.kr',:password => 'a12345', :password_confirmation => 'a12345',:birthday=>'1981-06-02',:job=>'연구원',:live_type_id=>1,:education_id=>5,:sex=>true,:enable=>true)
User.create!(:id=>6,:branch_id=>1,:name=>'나야나',:email => 'U10K-00004@jedaeroweb.co.kr',:password => 'a12345', :password_confirmation => 'a12345',:birthday=>'1981-06-02',:job=>'교수',:live_type_id=>2,:education_id=>2,:sex=>false,:enable=>true)
User.create!(:id=>7,:branch_id=>1,:name=>'뿌웅',:email => 'U10K-00005@jedaeroweb.co.kr',:password => 'a12345', :password_confirmation => 'a12345',:birthday=>'1981-06-02',:job=>'학생',:live_type_id=>1,:education_id=>1,:sex=>false,:enable=>true)
User.create!(:id=>8,:branch_id=>1,:name=>'꽁치',:email => 'U10K-00006@jedaeroweb.co.kr',:password => 'a12345', :password_confirmation => 'a12345',:birthday=>'1981-06-02',:job=>'조교수',:live_type_id=>2,:education_id=>1,:sex=>false,:enable=>true)
User.create!(:id=>9,:branch_id=>1,:name=>'ㅎㅎㅎㅎ',:email => 'U10K-00007@jedaeroweb.co.kr',:password => 'a12345', :password_confirmation => 'a12345',:birthday=>'1981-06-02',:job=>'연구원',:live_type_id=>2,:education_id=>5,:sex=>false,:enable=>true)
User.create!(:id=>10,:branch_id=>1,:name=>'쑤왕~',:email => 'U10K-00008@jedaeroweb.co.kr',:password => 'a12345', :password_confirmation => 'a12345',:birthday=>'1981-06-02',:job=>'대학원생(학생)',:live_type_id=>1,:education_id=>4,:sex=>true,:enable=>true)
...
Survey.create!(user_id: 1, title: '예제1', start_date: Date.today, end_date: 100.days.from_now, public_display: 1)
SurveyContent.create(survey_id: 1, content: '본 설문조사는(남: 10 ,여: 8) 문항으로 이루어져 있으며 더욱 정확하고 신뢰 있는정보를 도출하기 위해 필요한 자료입니다.
 성실하게 답변해주시기 바랍니다.
모든 문항에는 최소 한번 이상의 표시를 반드시 하셔야 합니다.')

QuestionCategory.create!(:id=>1,:survey_id=>1,:title=>'신체적 특성 / 생활 습관',:enable=>true)
QuestionCategory.create!(:id=>2,:survey_id=>1,:title=>'식습관에 관한 문항',:enable=>true)
QuestionCategory.create!(:id=>3,:survey_id=>1,:title=>'여성건강에 관한 문항',:female_only=>true,:enable=>true)


Question.create(:id=>1,:survey_id=>1,:question_category_id=>1,:title=>'혈액형 에 대해서 표시해 주십시오.',:enable=>true)
QuestionDescription.create(:question_id=>1,:description=>'정확히 모를경우는 모른다에 표시하세요')
Question.create(:id=>2,:survey_id=>1,:question_category_id=>1,:title=>'현재 키(cm)에 대해서 표시해 주십시오',:enable=>true)
Question.create(:id=>3,:survey_id=>1,:question_category_id=>1,:title=>'현재 몸무게(kg)에 대해서 표시해 주십시오',:enable=>true)
Question.create(:id=>4,:survey_id=>1,:question_category_id=>1,:title=>'왼손잡이입니까? 아니면 오른손잡이입니까?',:enable=>true)
Question.create(:id=>5,:survey_id=>1,:question_category_id=>2,:title=>'당신의 눈 색깔은?',:enable=>true)
Question.create(:id=>6,:survey_id=>1,:question_category_id=>2,:title=>'당신의 머리카락 상태는?',:enable=>true)
Question.create(:id=>7,:survey_id=>1,:question_category_id=>2,:title=>'흡연을 합니까?',:enable=>true)
Question.create(:id=>8,:survey_id=>1,:question_category_id=>2,:title=>'현재 음주를 합니까?',:enable=>true)
Question.create(:id=>9,:survey_id=>1,:question_category_id=>3,:title=>'생리는 규칙적입니까?',:enable=>true)
Question.create(:id=>10,:survey_id=>1,:question_category_id=>3,:title=>'출산을 했습니까?',:enable=>true)
...
SubAnswer.create!(:sub_question_id=>1,:title=>'1',:photo=>File.open(Rails.root.join("public", "images", "10_01.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'2',:photo=>File.open(Rails.root.join("public", "images", "10_02.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'3',:photo=>File.open(Rails.root.join("public", "images", "10_03.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'4',:photo=>File.open(Rails.root.join("public", "images", "10_04.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'5',:photo=>File.open(Rails.root.join("public", "images", "10_05.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'6',:photo=>File.open(Rails.root.join("public", "images", "10_06.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'7',:photo=>File.open(Rails.root.join("public", "images", "10_07.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'8',:photo=>File.open(Rails.root.join("public", "images", "10_08.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'9',:photo=>File.open(Rails.root.join("public", "images", "10_09.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'10',:photo=>File.open(Rails.root.join("public", "images", "10_10.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'11',:photo=>File.open(Rails.root.join("public", "images", "10_11.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'12',:photo=>File.open(Rails.root.join("public", "images", "10_12.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'13',:photo=>File.open(Rails.root.join("public", "images", "10_13.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'14',:photo=>File.open(Rails.root.join("public", "images", "10_14.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'15',:photo=>File.open(Rails.root.join("public", "images", "10_15.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'16',:photo=>File.open(Rails.root.join("public", "images", "10_16.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'17',:photo=>File.open(Rails.root.join("public", "images", "10_17.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'18',:photo=>File.open(Rails.root.join("public", "images", "10_18.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'19',:photo=>File.open(Rails.root.join("public", "images", "10_19.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'20',:photo=>File.open(Rails.root.join("public", "images", "10_20.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'21',:photo=>File.open(Rails.root.join("public", "images", "10_21.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'22',:photo=>File.open(Rails.root.join("public", "images", "10_22.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'23',:photo=>File.open(Rails.root.join("public", "images", "10_23.jpg")),:enable=>true)
SubAnswer.create!(:sub_question_id=>1,:title=>'24',:photo=>File.open(Rails.root.join("public", "images", "10_24.jpg")),:enable=>true)

Answer.create!(:id=>35,:question_id=>6,:title=>'머리숱이 풍성하다',:photo=>File.open(Rails.root.join("public", "images", "22_01.jpg")),:enable=>true)
Answer.create!(:id=>36,:question_id=>6,:title=>'머리숱이 보통이다',:photo=>File.open(Rails.root.join("public", "images", "22_02.jpg")),:enable=>true)
Answer.create!(:id=>37,:question_id=>6,:title=>'머리숱이 적다',:photo=>File.open(Rails.root.join("public", "images", "22_03.jpg")),:enable=>true)
Answer.create!(:id=>38,:question_id=>6,:title=>'약간 탈모가 있다',:photo=>File.open(Rails.root.join("public", "images", "22_04.jpg")),:enable=>true)
Answer.create!(:id=>39,:question_id=>6,:title=>'탈모되었다',:photo=>File.open(Rails.root.join("public", "images", "22_05.jpg")),:enable=>true)
Answer.create!(:id=>40,:question_id=>6,:title=>'머리카락이 거의 없다',:photo=>File.open(Rails.root.join("public", "images", "22_06.jpg")),:enable=>true)
